class LocalsController < ApplicationController
  ...
  private
    ...
    def local_params
      params.require(:local).permit(:nome, :descricao, :logradouro, :bairro, :tipo, :animacao, :interacao, :faixaEtaria, :longitude, :latitude, :imagem, :nota, :cod_linha, :preco, :telefone, :site, :horario_abre, :horario_fecha)
    end
end
